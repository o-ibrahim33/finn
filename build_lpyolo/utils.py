...
def load_and_preprocess_image(path):
    ...
    return image_name, image, image_org

def load_and_preprocess_dir(dir_path):
    ...
    for img_path in img_paths:
        image_name, image, image_org = load_and_preprocess_image(img_path)
        images.append(image)
        images_org.append(image_org)
        images_name.append(image_name)
    
    return images_name, images, images_org

def plot_boxes(pred, image, image_org):
    names = [
    "person",
    "bicycle",
    "car",
    ...
    return cv2.cvtColor(image_boxes, cv2.COLOR_BGR2RGB)
